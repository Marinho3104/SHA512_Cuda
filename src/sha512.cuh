...
namespace sha512::cuda {

    __device__ const uint64_t sha512_initial_h_values[] = {
    ...
    __device__ const uint64_t sha512_initial_k_values[] = {
    ...
    __device__ void Sha512_digest( Sha512_Context*, void* );
